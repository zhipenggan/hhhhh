...
$(document).on("click", ".l-sb-item", function(){
    ...
    switch (dataType){
        case "home":
            ...
            $("#top_bar")[0].style.display = "none";
            $(".home-tools")[0].style.display = "block";
            break;
        case "group":
            ...
            $("#top_bar")[0].style.display = "block";
            $(".home-tools")[0].style.display = "none";
            groupOffset = 0;
            getGroupList(initGroupList);
...
$(document).on("touchend", ".create-group", function () {
...
var show_program_flag = false;

$(document).on("touchend","#show_program_bar",function(){
    showOrHideProgramList();
});

function showOrHideProgramList(){
    if(!show_program_flag){
        $("#show_program").hide();
        $("#hide_program").show();
        $("#program_list").css("zIndex",999999);
        show_program_flag = true;
    }else{
        $("#show_program").show();
        $("#hide_program").hide();
        $("#program_list").css("zIndex",-999999);
        show_program_flag = false;
    }
}
...
$(document).on("click","#search-user-back",function(){
    $("#search-user-div")[0].style.visibility = "hidden";
    $("#wrapper-mask")[0].style.visibility = "hidden";
});

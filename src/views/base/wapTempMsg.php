        ...
        <div class="chatsession-row-header">
            <div class="chatsession-row-title ">
                <div style="display: flex;justify-content: center;align-items: center">
                    ...
                    {{/if}}
                    <span class="chatsession_nickname_{{chatSessionId}}" style="padding-top: 10px"> {{name}}</span>
...
<script id="tpl-invite-member-no-data" type="text/html">
    ...
    <div class="no_data">
        <div class="d-flex">
            ...
            <div class="p-2 no_data_tip" style="text-align: center" data-local-value="noFriendDataTip">暂无好友</div>
        </div>
    </div>
</script>
...
<script id="tpl-download-app-div" type="text/html">
    <img src="../../public/img/close.png" onclick="closeMaskDiv('#download-app-div');" style="float: right;margin-right:1rem;margin-top: 1rem " />
...
<!--            <img src="./public/img/back.png" style="left: 0;top: 0.5rem;"  id="search-user-back" />-->
...
<script type="text/html" id="tpl-create-group-div">
    <div>
        ...
        <div class="d-flex flex-row justify-content-center">
            <input type="text" class="form-control group_name create_group_box_div_input" maxlength="10"  onkeydown="createGroupByKeyDown(event)"  data-local-placeholder="enterGroupNamePlaceholder" placeholder="请输入群组名称" style="width: 70%">
        </div>
...
<script type="text/html" id="tpl-plugin-item">
    <div class="pw-home-row mini-program plugin-info pw-contact-row" plugin-name="{{name}}" plugin-id="{{id}}" plugin-landingPageUrl="{{landingPageUrl}}" plugin-duckchatSessionId="{{duckchatSessionId}}" plugin-loadingType="{{loadingType}}">
        <div class="pw-home-row-image" style="position: relative;">
            {{if logo}}
            <img  src="{{logo}}" onerror="this.src='{{siteAddress}}/public/img/plugin/default.png'"/>
            {{else}}
            <img  src="{{siteAddress}}/public/img/plugin/default.png"/>
            {{/if}}
            <div class="pw-home-row-name" data-local-value="miniProgramTip" style="padding-left: 10px;">{{name}}</div>
        </div>
    </div>
</script>

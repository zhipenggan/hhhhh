<div id="all-templates" style="display: none;">
    ...
    <div id="group-invite-people" class="pop-window pop-window-invite-people" style="    border-radius: 10px;">
        <div class="pw-left">
            <div class="no_data">
        ...
        <div style="position: fixed;bottom: 20px;">
            <button class=" cancle_invite_people" style="background: white" data-local-value="cancelTip">取消</button>
            <button class=" add_member_to_group" data-local-value="addTip">添加</button>
        </div>

        <div class="pw-right" style="display: none">
            ...
            <div class="pw-right-btn">
                <button class="btn-default cancle_invite_people" style="background: white" data-local-value="cancelTip">取消</button>
    ...
    <div id="edit-remark">
        ...
        <div class="d-flex flex-row justify-content-center" style="">
            <input type="text" class="form-control remark_name create_group_box_div_input" style="margin-left: 1rem;text-align: center" maxlength="16" onkeydown="editFriendRemarkByKeyDown(event)" data-local-placeholder="remarkNamePlaceholder"  placeholder="请输入备注" >
        </div>
